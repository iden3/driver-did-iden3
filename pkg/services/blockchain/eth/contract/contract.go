...
// GetStateInfoByIdAndState is a free data retrieval call binding the contract method .
//
...
func (_State *StateCaller) GetStateInfoByIdAndState(opts *bind.CallOpts, id *big.Int, state *big.Int) (StateV2StateInfo, error) {
	var out []interface{}
